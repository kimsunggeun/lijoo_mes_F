...
// [pro0070] 그리드 조회
export function getPro0070(param) {
  let data = param
  if (param.workDecode == null) { param.workDecode = '' }
  if (param.workCode == null) { param.workCode = '' }
  if (param.workCode.substring(0,1) != param.workDecode.substring(0,1)){ param.workDecode = '' }
  return request({
    url: `/api/getPro0070`,
    method: 'POST',
...
// [pro0070] 그리드 삭제
export function delPro0070(param) {
  let data = param
  return request({
    url: `/api/delPro0070`,
    method: 'POST',
...
// [pro0070] 그리드 저장
export function createPro0070(param) {
  console.log(param)
  let data = param

  return request({
    url: `/api/createPro0070`,
    method: 'POST',
    meta: { apiVersion: '1.0.0' },
    headers: { 'Content-Type': 'application/json;charset=utf8' },
    data
...
export function getBas0090(param) {
  let data = param
  return request({
    url: `/api/getBas0090`,
    method: 'POST',
